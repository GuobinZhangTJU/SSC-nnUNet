...
setup(name='nnunet',
      ...
      entry_points={
          'console_scripts': [
              ...
              'nnUNet_plan_and_preprocess_Brachytherapy = nnunet.experiment_planning.nnUNet_plan_and_preprocess:main',
              'nnUNet_train_Brachytherapy = nnunet.run.run_training:main',
              'nnUNet_train_DP = nnunet.run.run_training_DP:main',
              'nnUNet_train_DDP = nnunet.run.run_training_DDP:main',
              'nnUNet_predict_Brachytherapy = nnunet.inference.predict_simple:main',
