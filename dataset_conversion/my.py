...
if __name__ == "__main__":
    base = "/data2/A0_MSD_Final_For_Paper/DATASET/nnUNet_raw/nnUNet_raw_data/Task067_Combine"
    ...
    out_base = "/data2/A0_MSD_Final_For_Paper/DATASET/nnUNet_raw/nnUNet_raw_data/test"
    ...
    for p in files_train_image:
        ...
        label_file = join(imagestr_read, p[:11])
        image_file = join(labelstr_read, p[:11])
    ...
    json_dict['name'] = "Combine"
    json_dict['description'] = "Combine"
